...
import { Shield, KeyRound, User, Lock, Eye, EyeOff, X, CheckCircle2, ArrowRight, RefreshCw } from 'lucide-react';
...
export default function AdminLoginModal({ isOpen, onClose, onLoginSuccess, adminPasscode, onUpdatePasscode }: AdminLoginModalProps) {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
        <div className="relative w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden p-6 sm:p-8 space-y-6">
          ...
          <div className="pt-4 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-400">
            <span>Default: <strong className="text-emerald-400">admin</strong> / <strong className="text-emerald-400">admin</strong></span>
            <button
              onClick={() => setShowChangePasswordModal(true)}
