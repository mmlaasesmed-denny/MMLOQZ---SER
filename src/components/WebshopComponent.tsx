...
export default function WebshopComponent({ 
  ...
  return (
    <div className="@container w-full max-w-7xl mx-auto bg-white text-slate-800 relative overflow-hidden font-sans py-2 px-4 @md:px-8 @lg:px-12 shadow-sm rounded-xl border border-transparent @md:border-slate-100">
